                ...
                <td class="main-content">
                  <table width="100%" cellspacing="0" cellpadding="0" border="0">
                    <tbody>
                      ...
                      <tr>
                        <td style="padding: 0 0 10px; font-size: 14px; line-height: 150%;">
                          Thank you for registering with us! We are thrilled to have you on board. Your account associated with the email <span style="color: #4C83EE;">{{email}}</span> has been successfully created.
                        </td>
                      </tr>
                      <tr>
